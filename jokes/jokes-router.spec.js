...
describe('jokes-router.js', () => {
  ...
  describe('GET /', () => {
    it('should return a json object', async () => {
      const res = await request(server.use(jokesRouter)).get('/');
    ...
    // why would I ever test this.. dunno
    it(`should return the expected response body to a GET request to 'https://icanhazdadjoke.com/search'`, async () => {
      const res = await request(server.use(jokesRouter)).get('/');
